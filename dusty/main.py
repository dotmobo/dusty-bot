...
def create_tweet(client):
    ...
    user_content = "Write a fun, creative, or even slightly cheeky and savage tweet about the Dusty Bones project or Shadow Lands game. Highlight game mechanics, tokenomics, or community vibes, and feel free to include jokes, pop culture references, playful taunts, or trolling other crypto communities—but keep it under 280 characters!"
